...
\newcommand{\step}[1]{\ensuremath{\xrightarrow{#1}}}
\newcommand{\steps}[1]{\ensuremath{\xrightarrow{#1}\negthickspace\raisebox{0.4ex}{\scriptsize *}\,}}

\newcommand{\sstep}[1]{\ensuremath{\xrightarrow{#1}_S}}
\newcommand{\ssteps}[1]{\ensuremath{\xrightarrow{#1}_S\negthickspace\raisebox{0.4ex}{\scriptsize *}\,}}
